...
def _display_no_agent_guide(endpoint: Optional[str] = None) -> None:
    ...
    if endpoint:
        ...
        console.print()
        console.print("  [dim]Agent examples (copy-paste ready):[/dim]")
        console.print("  [dim]examples/backend-implementations.md[/dim]   [link=https://github.com/hidai25/eval-view/blob/main/examples/backend-implementations.md]open ↗[/link]")
    else:
