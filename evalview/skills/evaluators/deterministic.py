...
from evalview.skills.evaluators._security_checks import SecurityChecksMixin
# Re-exported for backward compat — historical callers imported these from here.
from evalview.skills.evaluators._security_patterns import (  # noqa: F401
...
class DeterministicEvaluator(SecurityChecksMixin):
